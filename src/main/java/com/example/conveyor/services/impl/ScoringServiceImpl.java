...
public class ScoringServiceImpl implements ScoringService {
    ...
    private LoanOfferDTO createOffer(Boolean isInsuranceEnabled,
        ...
        BigDecimal totalAmount = amountCalculationService
                .getAmountViaInsurance(applicationRequest.getAmount(), isInsuranceEnabled, INSURANCE);
        totalAmount = amountCalculationService
    ...
    public CreditDTO createCreditOffer(ScoringDataDTO scoringData) {
        ...
        BigDecimal totalAmount = amountCalculationService.getAmountViaInsurance(scoringData.amount(), scoringData.isInsuranceEnabled(), INSURANCE);
        totalAmount = amountCalculationService.getTotalAmountViaRate(totalAmount, personalRate, scoringData.term());
